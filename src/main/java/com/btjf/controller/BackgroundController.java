...
public class BackgroundController {
    ...
    public XaResult<List<EvaluateVo>> search(@ApiParam("当前页") Integer currentPage,
        ...
        xaResult.setSuccess(list);
        xaResult.setPage(new com.btjf.application.page.Page(page, PlatformSourceEnum.WEB));
        return xaResult;
    }
